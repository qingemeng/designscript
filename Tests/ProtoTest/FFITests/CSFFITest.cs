...
p11;
        ...
        public void T024_disposeininclude_1467252()
        {
            ...
            ExecutionMirror mirror = thisTest.RunScriptFile(testPath, "file_1467252_master.ds");
        ...
        public void T025_disposeinimperative_1464937()
        {
            ...
            string error = "";
            ExecutionMirror mirror = thisTest.RunScriptFile(testPath, "T025_disposeinimperative_1464937.ds");
            thisTest.SetErrorMessage(error);
